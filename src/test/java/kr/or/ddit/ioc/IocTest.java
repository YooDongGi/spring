...
public class IocTest {
	...
	public void beanScopeTest() {
		// 디자인 패턴 singleton 개념으로 보면 두개의 객체는 한 클래스로부터 나왔으므로 동일 해야함
		// 하지만 스프링의 singleton 개념은 bean 엘레멘트를 기준으로 하나의 객체가 생성된다
		assertNotEquals(userService1, userServiceCons);
	}
	
	@Test
	public void beanScopeTest2() {
		// 동일한 스프링 빈을 주입받았으므로 userService1, userService2는 같은 객체다
	...
	public void propertyPlaceholderTest() {
		...
		assertEquals("ydg", dbConfig.getUsername());
